...
\title{Priced Out: A Methodological Framework for Tracking Post-COVID Restaurant Inflation and Closure Risk Across American Cuisines\thanks{Code and reproduction instructions: \url{https://github.com/Osokenha/priced-out}}}

\author{%
  Adam Assina, Zain Soomro, Oomer Syed\\
  CS439 Final Project\\
  \texttt{ada150@scarletmail.rutgers.edu}\\
  \texttt{zs416@scarletmail.rutgers.edu}\\
  \texttt{os223@scarletmail.rutgers.edu}\\
}
